...
%based on correlation coefficient,” in 2015 2nd International Conference on
%Knowledge-Based Engineering and Innovation (KBEI), 2015, pp. 632-639.
...
% The Artificial Blurred images are obtained by passing them through a
...
% Divide source images into 8*8 blocks and perform the fusio
for i = 1:floor(m/8)
    for j = 1:floor(n/8)
